...
#pragma warning disable // Disable all warnings
    ...
    [GeneratedCode("NSwag", "11.16.1.0 (NJsonSchema v9.10.41.0 (Newtonsoft.Json v9.0.0.0))")]
    public interface IController
    {
        ...
        /// <returns>Ok</returns>
        Task<SignResponse> SignAsync(string api_version, string name, string genid, SignRequest payload);
        ...
        /// <returns>OK</returns>
        Task<EncryptResponse> EncryptAsync(string api_version, string name, string genid, EncryptRequest payload);
        ...
        /// <returns>OK</returns>
        Task<DecryptResponse> DecryptAsync(string api_version, string name, string genid, DecryptRequest payload);

        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the module to get certificate. (urlencoded)</param>
        /// <param name="genid">The generation identifier for the module as generated by IoT Hub.</param>
        /// <returns>Ok</returns>
        Task<CertificateResponse> CreateIdentityCertificateAsync(string api_version, string name, string genid);
        ...
        /// <returns>Ok</returns>
        Task<CertificateResponse> CreateServerCertificateAsync(string api_version, string name, string genid, ServerCertificateRequest request);

        /// <param name="api_version">The version of the API.</param>
        /// <returns>Ok</returns>
        Task<TrustBundleResponse> TrustBundleAsync(string api_version);
    }
    ...
    public partial class Controller : AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="payload">The data to be signed.</param>
        /// <returns>Ok</returns>
        [HttpPost, Route("modules/{name}/genid/{genid}/sign")]
        public Task<SignResponse> Sign(string api_version, string name, string genid, [FromBody] SignRequest payload)
        {
        ...
        /// <param name="payload">The data to be encrypted.</param>
        /// <returns>OK</returns>
        [HttpPost, Route("modules/{name}/genid/{genid}/encrypt")]
        public Task<EncryptResponse> Encrypt(string api_version, string name, string genid, [FromBody] EncryptRequest payload)
        {
        ...
        /// <param name="payload">The data to be decrypted.</param>
        /// <returns>OK</returns>
        [HttpPost, Route("modules/{name}/genid/{genid}/decrypt")]
        public Task<DecryptResponse> Decrypt(string api_version, string name, string genid, [FromBody] DecryptRequest payload)
        {
        ...
        /// <param name="genid">The generation identifier for the module as generated by IoT Hub.</param>
        /// <returns>Ok</returns>
        [HttpPost, Route("modules/{name}/genid/{genid}/certificate/identity")]
        public Task<CertificateResponse> CreateIdentityCertificate(string api_version, string name, string genid)
        {
        ...
        /// <param name="request">Parameters for certificate creation.</param>
        /// <returns>Ok</returns>
        [HttpPost, Route("modules/{name}/genid/{genid}/certificate/server")]
        public async Task<IActionResult> CreateServerCertificate(string api_version, string name, string genid, [FromBody] ServerCertificateRequest request)
        {
        ...
        /// <param name="api_version">The version of the API.</param>
        /// <returns>Ok</returns>
        [HttpGet, Route("trust-bundle")]
        public Task<TrustBundleResponse> TrustBundle(string api_version)
        {
            return _implementation.TrustBundleAsync(api_version);
        }
    }

    [GeneratedCode("NJsonSchema", "9.10.41.0 (Newtonsoft.Json v9.0.0.0)")]
